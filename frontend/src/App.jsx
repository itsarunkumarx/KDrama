...
const ProtectedRoute = ({ children }) => {
  ...
  if (loading) return (
    <div className="min-h-screen bg-kdark flex items-center justify-center">
      <div className="text-kred text-5xl font-display tracking-widest animate-pulse">KDRAMAX</div>
    </div>
  );
  ...
  return (
    <div className="min-h-screen bg-kdark">
      ...
      <Routes>
        ...
        <Route path="/party/:roomId" element={<ProtectedRoute><WatchParty /></ProtectedRoute>} />
